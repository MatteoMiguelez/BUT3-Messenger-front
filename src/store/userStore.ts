...
function getUsers(): User[] {
  ...
  return { setConnectedUser, getConnectedUser, fetchUsers, getUsers, getConnectedUsers, setConnectedUsers, addConnectedUser, isConnected, fetchConnectedUsers, getUserProfilPicIdById, getUserNameById }
})
